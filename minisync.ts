...
// Synchronizable object classes
     ...
     * @constructor
     */
    function Syncable(document: any, data: any, restore?: boolean): void {
     ...
     * @internal
     */
    Syncable.prototype.setDocument = function(document: any): void {
     ...
     * @internal
     */
    Syncable.prototype.setData = function(data: any, restore?: boolean): void {
        this.data = data;
     ...
     */
    Syncable.prototype.getData = function(): any {
     ...
     * @returns {*}
     */
    Syncable.prototype.getState = function(): any {
     ...
     */
    Syncable.prototype.updateState = function(): any {
     ...
     * @returns {String}
     */
    Syncable.prototype.getID = function(): string {
     ...
     * @returns {string}
     */
    Syncable.prototype.getVersion = function(): string {
     ...
     * @returns {String}
     */
    Syncable.prototype.getTimeStamp = function(): string {
     ...
     * @param value
     */
    Syncable.prototype.set = function(key: string, value: any): void {
     ...
     */
    Syncable.prototype.get = function(key: string, ifRemoved?: boolean): any {
        let keyParts = String(key).split('.');
        key = keyParts.shift();
        let value = this;
        // [1], foo[1], foo[1][2]
     ...
     */
    Syncable.prototype.remove = function(): void {
        if (!this.isRemoved()) {
            let state = this.getState();
     ...
     * @returns {String|null}
     */
    Syncable.prototype.isRemoved = function(): string {
     ...
     */
    Syncable.prototype.getChangesSince = function(version: string, resultSetter: any): any {
        let result: any = null;
     ...
     */
    Syncable.prototype.getChangesResultObject = function(): AnyWithState {
     ...
     */
    Syncable.prototype.mergeChanges = function(changes: AnyWithState, clientState: any): void {
        if (!changes) return;
        ...
        Object.keys(changes).forEach(function(key: string) {
            if (key === '_s') return;
            let remoteValue: any = (<any>changes)[key];
            // if primitive value
     ...
     * @constructor
     */
    function SyncableArray(document: any, data: any, restore?: boolean): void {
        if (restore) {
     ...
     * @returns {Array}
     */
    SyncableArray.prototype.getData = function(): any {
        let result: any = null;
     ...
     * @returns {*} this object and all its changed properties, or null if nothing changed
     */
    SyncableArray.prototype.getChangesSince = function(version: string): any {
     ...
     * @returns {{_s: {id: String, u: string, t: String}}}
     */
    SyncableArray.prototype.getChangesResultObject = function(): AnyWithState {
        let result: any = Syncable.prototype.getChangesResultObject.call(this);
        result._s.a = true;
        result.v = [];
     ...
     * @param clientState
     */
    SyncableArray.prototype.mergeChanges = function(changes: any, clientState: any): void {
        /*
        Assumptions:
     ...
     */
    SyncableArray.prototype.sortByRemote = function(remote: Array<any>): Array<any> {
        let data = this.data;
     ...
     */
    SyncableArray.prototype.mergeInterval = function(interval: any): void {
     ...
     * @return object
     */
    SyncableArray.prototype.getIdMap = function(): any {
        let localValue: any;
     ...
     */
    SyncableArray.prototype.removeAt = function(index: number): any {
     ...
     * @returns {Array}
     */
    SyncableArray.prototype.getRemoved = function(): Array<string> {
        let state = this.getState();
     ...
     * @returns {number}
     */
    SyncableArray.prototype.length = function(): number {
        return this.data.length;
    };

    SyncableArray.prototype.forEach = function(callback: any, thisArg: any): void {
     ...
     * @returns {*}
     */
    SyncableArray.prototype.indexOf = function(searchElement: any, fromIndex: number, isObjectID?: boolean): number {
    ...
    SyncableArray.prototype.lastIndexOf = function(searchElement: any, fromIndex?: number): number {
        if (searchElement instanceof Syncable) {
    ...
    SyncableArray.prototype.pop = function(): any {
    ...
    SyncableArray.prototype.push = function(): any {
        this.getState().u = this.document.nextDocVersion();
        return this.data.push.apply(this.data, arguments);
    };

    SyncableArray.prototype.reverse = function(): any {
        this.getState().u = this.document.nextDocVersion();
        this.data.reverse();
        return this;
    };

    SyncableArray.prototype.shift = function(): any {
     ...
     */
    SyncableArray.prototype.splice = function(index: number, howMany?: number, ...elements: any[]): any {
     ...
     * @returns {Array}
     */
    SyncableArray.prototype.slice = function(begin: number, end: number): Array<any> {
        return this.data.slice(begin, end);
    };

    SyncableArray.prototype.unshift = function(element: any): any {
        this.getState().u = this.document.nextDocVersion();
    ...
    (function() {
        ...
        var createArrayFn = function(fn: any) {
            return function() {
     ...
     */
    function Document(data: any, restore?: boolean): void {
     ...
     * @return {string}
     */
    Document.prototype.getClientID = function(): string {
     ...
     * @internal
     */
    Document.prototype.setClientID = function(id: string): void {
     ...
     * @returns {string}
     */
    Document.prototype.getDocVersion = function(): string {
     ...
     * @internal
     */
    Document.prototype.setDocVersion = function(v: string): void {
        this.getState().v = v;
    };
     ...
     * @returns {string}
     */
    Document.prototype.nextDocVersion = function(): string {
     ...
     */
    Document.prototype.getClientState = function(clientID: string): any {
     ...
     * @returns {Array}
     */
    Document.prototype.getClientStates = function(): Array<any> {
        let state: any = this.getState();
     ...
     * @internal
     */
    Document.prototype.setClientStates = function(states: Array<any>): void {
        let state: any = this.getState();
        state.remote = states || [];
    };
     ...
     */
    Document.prototype.getChanges = function(clientID: string): any {
     ...
     * @returns {*} data object to send
     */
    Document.prototype.mergeChanges = function(data: any): void {
...
// Public API
    ...
    function minisync(data: any): any {
